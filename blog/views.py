    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    return redirect('blog:payment', payment_option='stripe')
                elif payment_option == 'P':
                    return redirect('blog:payment', payment_option='paypal')
                else:
                    messages.warning(
            ...
            return redirect("blog:order-summary")
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            return redirect("blog:product", slug=slug)
    else:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("blog:request-refund")
